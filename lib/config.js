...
export const IMAGE_PROVIDERS = {
  ...
  deepseek: {
    name: 'DeepSeek',
    description: 'DeepSeek own image generation model',
  ...
  minimax: {
    name: 'MiniMax',
    description: 'MiniMax image generation API',
  ...
  flux: {
    ...
    description: 'High quality Flux model via Replicate or Fal.ai',
  ...
  baidu_ernie: {
    name: 'Baidu Wenxin Yige',
    description: 'Baidu ERNIE Image Generation (文心一格)',
  ...
  tencent_hunyuan: {
    ...
    description: 'Tencent Hunyuan Image Generation (混元)',
  ...
  aliyun_wanx: {
    ...
    description: 'Alibaba Wanxiang Image Generation (通义万相)',
