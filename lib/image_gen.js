  ...
  try {
    ...
    switch (provider) {
      ...
      case 'stable_diffusion':
        ...
        break;
      case 'agnes':
        result = await generateWithAgnes(prompt, providerConfig, { width, height, num_images, imageUrls });
        break;
      case 'comfy':
        result = await generateWithComfy(prompt, providerConfig, { width, height, num_images });
        break;
      default:
